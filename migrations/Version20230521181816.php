 ...
 */
final class Version20230521181816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module ADD course_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C242628591CC992');
        $this->addSql('ALTER TABLE module DROP course_id');
    }
}
